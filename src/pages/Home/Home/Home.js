...
const Home = () => {
  return (
    <div id="home" className="section hero min-h-screen">
      <div className="heroContainer hero-content md:gap-6 p-0">
        <img
          alt=""
          src={laptop}
          className="bannerImage md:max-w-[500px] max-w-[320px]"
        />
        <div className="max-w-[600px]">
          <h1 className="bannerText md:text-[85px] text-[46px] md:leading-[85px] leading-[53px] bannerTexts">
            Hello,
          </h1>
          <h1 className="bannerText md:text-[85px] text-[46px] md:leading-[85px] leading-[53px] bannerTexts">
          ...
          <button className="bannerButton btn btn-primary btn-outline  mt-8 ml-1">
