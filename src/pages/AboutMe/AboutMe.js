...
const AboutMe = () => {
  ...
  return (
    <div id="about" className="section relative about hero min-h-screen">
      ...
      <div className="heroContainer hero-content gap-x-20">
        <img src={about} className="aboutMeImage rounded-lg" alt="" />
        <div className="aboutMeTexts md:max-w-[450px] max-w-[330px]">
          <h1 className="aboutMeHeader md:text-[45px] text-[32px] font-bold">
